                            ...
                            <table className="w-full">
                                <thead className="bg-linear-to-r from-indigo-600 to-purple-600 text-white">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-sm font-semibold">Encargado</th>
                                    ...
                                    {solicitudes.map((solicitud) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div>
                                                    <p className="font-semibold text-gray-800">{solicitud.nombreSolicitud}</p>
                                                    <p className="text-xs text-gray-500">{solicitud.descripcionSolicitud}</p>
                                                </div>
                                            </td>
