...
const Testigos = (props: Solicitud) => {
        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-2 pb-3 border-b border-b-blue-300">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    <span>Datos de los Testigoss</span>
                </h3>
                {tipoSolicitudNombre && (
            ...
            <h1 className="text-xl font-bold text-gray-800">Testigos 1</h1>
            ...
            <h1 className="text-xl font-bold text-gray-800">Testigos 2</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {/* Tipo de Documento */}
                <div className='mb-0'>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
