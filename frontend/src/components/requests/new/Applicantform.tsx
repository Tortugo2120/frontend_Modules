                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                            <div className='mb-0'>
                                ...
                                <input
                                    type="text"
                                    {...register('dni')}
                                    className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.dni ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                        }`}
