...
export default function ApplicantForm({
    ...
    const handleSearchApplicant = useCallback(async () => {
        ...
        try {
            ...
            setValue('cui', numDni);
            setValue('documentTypeId', documentTypeNumber);
    ...
    const handleAddSolicitante = (() => {
        ...
        const isDuplicate = solicitantesAgregados.some(s => s.cui === data.cui);
        if (isDuplicate) {
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <div className="flex-1">
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 text-sm sm:text-base border-2 rounded-lg font-medium uppercase outline-0 transition-all focus:ring-2 focus:ring-yellow-500 ${expedientError
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                        <div className='mb-0'>
                            ...
                            <input
                                type="text"
                                {...register('cui')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.cui ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                placeholder="8 dígitos"
                                maxLength={8}
                            />
                            {errors.cui && (
                                <p className="text-red-500 text-xs mt-1">{errors.cui.message}</p>
                            )}
                        </div>
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                type="text"
                                {...register('names')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.names ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                placeholder="Nombres"
                            />
                            {errors.names && (
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                ...
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.paternalSurname ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                ...
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.maternalSurname ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                        ...
                        <div className='mb-0'>
                            ...
                            <input
                                type="date"
                                {...register('birthdate')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.birthdate ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                            />
                            {errors.birthdate && (
                        ...
                        <div className='mb-0'>
                            ...
                            <select
                                {...register('gender')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.gender ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                            >
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-2'>
                            ...
                            <input
                                type="text"
                                {...register('address')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.address ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                type="email"
                                {...register('email')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.email ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                type="text"
                                {...register('phone')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.phone ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <input
                                type="text"
                                {...register('ubigeoId')}
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.ubigeoId ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                placeholder="140101"
                                maxLength={6}
                            />
                        ...
                        <div className='mb-0 sm:col-span-2 lg:col-span-1'>
                            ...
                            <select
                                ...
                                className={`w-full px-3 sm:px-4 py-2 text-sm sm:text-base border rounded-lg bg-white outline-0 transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.maritalStatus ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                            >
