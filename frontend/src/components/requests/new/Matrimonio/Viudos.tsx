...
interface ViudoProps {
    onRequisitosChange?: (requisitos: RequisitoViudo[]) => void;

}

const REQUISITOS_Viudo: RequisitoViudo[] = [
    {
        id: '1',
        titulo: 'Partida de Matrimonio Anterior.',
    ...
    {
        id: '2',
        titulo: 'Partida de deunción del contrayente fallecido.',
    ...
    {
        id: '3',
        titulo: 'Copia actualizada de DNI',
        descripcion: 'Debe contener la (V) de viudo.',
        obligatorio: true,
        completado: false
    }
        ...
        <div>
            ...
            <div className="space-y-3">
                <h4 className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                    ...
                    Requisitos adicionales para Viudos
                </h4>

                <div className="bg-white border border-gray-200 rounded-lg divide-y divide-gray-200">
                    {requiViudo.map((requisito, index) => (
                        <div
                            key={requisito.id}
