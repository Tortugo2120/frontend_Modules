...
export default function Dashboard() {
  ...
  return (
    <div className={"flex min-h-screen"}>
      ...
      <aside
        className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} w-72 bg-primary text-white flex flex-col min-h-screen fixed left-0 top-0 bottom-0 z-50 transition-transform duration-300 lg:translate-x-0 lg:static`}
      >
        <div className="px-8 py-7 border-b border-primary-light/30">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200 text-xs font-normal">
                José Leonardo Ortiz
              </p>
            </div>
          </div>
